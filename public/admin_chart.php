...
<body>
    ...
    <div class="flex-auto top-24 flex justify-end space-x-4 mr-4">
        ...
        <div class="flex flex-col space-y-3 pt-1">
            <button class="bg-gray-100 text-black px-3 py-2 rounded-md hover:bg-yellow-300 transition duration-200 "onclick="showAlert()">HAPUS</button>
